...
function SearchAvailableModalContent({
    ...
    availableRoomsListHook: Dispatch<SetStateAction<ApiRoomsList>>;
}) {
        ...
        <>
            <div className="actions_selector">
                <div
                    ...
                    data-ref="edt-finder"
                    className={`action ${activeTab == "edt-finder" ? "tab-active" : ""}`}
                >
                    EDT des salles
                </div>
                <div
                    onClick={() => setActiveTab("room-finder")}
                    data-ref="room-finder"
                    className={`action ${activeTab == "room-finder" ? "tab-active" : ""}`}
                >
                    Trouver une salle
                </div>
            </div>
            ...
            <div className="actions_container">
                <div
                    className={`edt-finder ${activeTab == "edt-finder" ? "displayed" : ""}`}
                >
                    <Input
                        className="search"
                        type="text"
                ...
                >
                    ...
                    <RoomsList
                        ...
                        roomsList={availableRoomsList.data}
